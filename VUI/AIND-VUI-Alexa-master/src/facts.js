...
module.exports = {
    "FACTS_EN": [
        ...
        "In June 1963, MIT received a USD2.2 million grant from the newly created Advanced Research Projects Agency (later known as DARPA).",
        "According to Wikipedia, the field of AI research was founded at a workshop held on the campus of Dartmouth College during the summer of 1956.",
        "As early as 1950, an important goal of AI research was to allow computers to communicate in natural languages.",
        "In 1958, Herbert Simon and Allen Newell said that within ten years a digital computer would be the world's chess champion and that within ten years a digital computer would discover and prove an important new mathematical theorem.",
        "A form of neural network, called a perceptron, was introduced in 1958 by Frank Rosenblatt.",
